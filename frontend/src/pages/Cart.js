                    ...
                    <div class="row d-flex justify-content-between">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-lg-2 mt-4 mt-lg-0">
                                            <p id="card_item_price"><FontAwesomeIcon icon={faIndianRupeeSign} />{item.product.price}</p>
                                        </div>
                        ...
                        <div class="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Est. total: <span class="order-summary-values"><FontAwesomeIcon icon={faIndianRupeeSign} />{Number(cartItems.reduce((acc,item)=> (acc + item.product.price * item.qty), 0)).toFixed(2)}</span></p>
